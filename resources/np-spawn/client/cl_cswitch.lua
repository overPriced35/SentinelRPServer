...
Citizen.CreateThread(function()
    local spawnZone = BoxZone:Create(vector3(-3962.55, 2014.91, 500.91), 31.2, 20.2, {
        name="spawn",
        offset={0.0, 0.0, 0.0},
        scale={1.0, 1.0, 1.0},
        heading=340,
    ...
    --[[
	exports["PolyZone"]:BoxZone:Create("spawnZone", vector3(-3962.55, 2014.91, 500.91), 31.2, 20.2,  {
		name="spawn",
        heading=340,
        minZ=498.51,
        maxZ=506.31
