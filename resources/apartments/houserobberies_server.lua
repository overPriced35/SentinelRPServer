local robbableItems = {
 ...
 [2] = {chance = 5, id = 'plastic', quantity = math.random(1, 4)}, -- rare
 [3] = {chance = 5, id = 'aluminium', quantity = math.random(1, 4)}, -- really common
 [4] = {chance = 5, id = 'copper', quantity = math.random(1,4)}, -- rare
 [5] = {chance = 5, id = 'electronics', quantity = math.random(1,4)}, -- rare
 [6] = {chance = 5, id = 'rubber', quantity = math.random(1,4)}, -- rare
 [7] = {chance = 5, id = 'scrapmetal', quantity = math.random(1,4)}, -- rare
 [8] = {chance = 5, id = 'steel', quantity = math.random(1,4)}, -- rare
 [9] = {chance = 5, id = 'joint', quantity = math.random(1,2)}, -- rare
 [10] = {chance = 10, id = 'highgradefemaleseed', quantity = math.random(1,1)}, -- rare
 [11] = {chance = 9, id = 'highgrademaleseed', quantity = math.random(1,1)}, -- rare
 [12] = {chance = 4, id = 'sandwich', quantity = 1},
 [13] = {chance = 4, id = 'water', quantity = math.random(1)},
 [14] = {chance = 8, id = 'rolex', quantity = math.random(1, 2)},
...
AddEventHandler('houseRobberies:giveMoney', function()
 ...
 TriggerClientEvent('cash:add',cash)
 ...
 for i=1, math.random(1, 2) do
  ...
  if math.random(1, 14) >= item.chance then
    if tonumber(item.id) == 0 and not gotID[item.id] then
        gotID[item.id] = true
        TriggerClientEvent('cash:add',item.quantity)
