TokoVoipConfig = {
	...
	wsServer = "135.148.33.8:33250", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSChannel = "JDM5",
		TSPassword = "member", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "ts.jdm5.online", -- TeamSpeak server address to be displayed on blocking screen
